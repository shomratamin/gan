...
class DataLoader():
    ...
    def load_data(self, batch_size=1, is_testing=False):
        gt_path = glob('{}/gt/*.jpg'.format(self.dataset_name))
        # gt_path.extend(glob('{}/gt/*.jpg'.format(self.dataset_name)))
        ...
        for f in gt_path[:500]:
            ...
            ch_file = '{}/gen/{}'.format(self.dataset_name,base_name)
    ...
    def load_batch(self, batch_size=1, is_testing=False):
        gt_path = glob('{}/gt/*.png'.format(self.dataset_name))
        gt_path.extend(glob('{}/gt/*.jpg'.format(self.dataset_name)))
        # print(gt_path)
        random.shuffle(gt_path)
        pairs = []
