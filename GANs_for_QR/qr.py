...
class Pix2Pix():
    def __init__(self):
        ...
        self.combined.load_weights('saved_model/full_4.h5')
    ...
    def sample_images(self, epoch, batch_i):
        ...
        for i in range(fake_a.shape[0]):
            cv2.imwrite(f'images/datasets/{epoch}_{i}.jpg', fake_a[i,:,:,:])
...
if __name__ == '__main__':
    gan = Pix2Pix()
    gan.train(epochs=200, batch_size=4, sample_interval=50)
